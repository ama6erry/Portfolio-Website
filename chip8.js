...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "web/chip8.data";
    var REMOTE_PACKAGE_BASE = "chip8.data";
    ...
    async function runWithFS(Module) {
      ...
      Module["FS_createPath"]("/roms", "games", true, true);
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_web/chip8.data");
      }
      Module["addRunDependency"]("datafile_web/chip8.data");
  ...
  loadPackage({
    files: [
      { filename: "/roms/3-corax+.ch8", start: 0, end: 761 },
      { filename: "/roms/4-flags.ch8", start: 761, end: 1802 },
      { filename: "/roms/6-keypad.ch8", start: 1802, end: 2715 },
      { filename: "/roms/IBM.ch8", start: 2715, end: 2847 },
      { filename: "/roms/games/br8kout.ch8", start: 2847, end: 3046 },
      { filename: "/roms/games/flightrunner.ch8", start: 3046, end: 3341 },
      { filename: "/roms/games/snake.ch8", start: 3341, end: 4779 },
      { filename: "/roms/test_opcode.ch8", start: 4779, end: 5257 },
    ],
    remote_package_size: 5257,
  });
})();
var programArgs = [];
...
var ASM_CONSTS = {
  ...
  78138: () => window.innerWidth,
  78168: () => window.innerHeight,
};
var _main,
  _malloc,
